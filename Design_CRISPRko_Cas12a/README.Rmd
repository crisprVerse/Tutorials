...
The `queryTxObject` function allows us to query this object by feature for specific gene(s). Here, we obtain a `GRanges` object containing the CDS coordinates of KRAS:
