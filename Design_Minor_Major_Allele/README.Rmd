...
As an example, using `BSgenome.Hsapiens.UCSC.hg38.dbSNP151.minor`, we can target a pathogenic minor allele ([rs398122995](https://www.ncbi.nlm.nih.gov/clinvar/variation/92240/?oq=rs398122995&m=NM_001378454.1(ALMS1):c.1897C%3ET%20(p.Gln633Ter))) in the human ALMS1 gene. We also include, for comparison, the resulting `GuideSet` using the reference genome sequence.
