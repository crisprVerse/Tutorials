...
First, we install the necessary packages from Bioconductor
...
the genomic coordinates (hg38 genome) of human protein-coding:

```{r}
data(txdb_human, package="crisprDesignData")
```

We get the exonic coordinates of the canonical transcript ENST00000311936 
...
of the exon. To be able to find good gRNA caniddate, let's define those regions
...
to specify a BSgenome package containing the reference genome DNA
sequences:
